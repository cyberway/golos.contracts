...
public:
    ...
    void create_message(structures::mssgid message_id, structures::mssgid parent_id, uint64_t parent_recid,
        ...
        std::string jsonmetadata, int64_t curators_prcnt);
    ...
    void set_curators_prcnt(structures::mssgid message_id, int64_t curators_prcnt);
private:
    ...
    base_t check_curators_prcnt(int64_t curators_prcnt);
